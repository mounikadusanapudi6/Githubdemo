...
//      htmlReporter.config().setTestViewChartLocation(ChartLocation.TOP);
  ...
  public void testRegistration() throws InterruptedException {
         ...
         driver.get("http://172.31.36.202:443/TestMeApp/fetchcat.htm#");
          ...
          sp.click();
          driver.findElement(By.xpath("//*[@id=\"userName\"]")).sendKeys("Sriya12243");
         ...
         System.out.println("user notified with this message : "+Actualtext);
          ...
          driver.findElement(By.xpath("//input[@id='firstName']")).sendKeys("Mouni");
          driver.findElement(By.xpath("//input[@id='lastName']")).sendKeys("Sai");
          driver.findElement(By.xpath("//input[@name='password']")).sendKeys("Mouni123");
          driver.findElement(By.xpath("//*[@id=\"pass_confirmation\"]")).sendKeys("Mouni123");
          driver.findElement(By.xpath("/html/body/main/div/div/form/fieldset/div/div[6]/div/div/label/span[2]")).click();
          driver.findElement(By.xpath("//*[@id=\"emailAddress\"]")).sendKeys("Mouni123@gmail.com");
          driver.findElement(By.xpath("//*[@id=\"mobileNumber\"]")).sendKeys("9999999999");
          driver.findElement(By.xpath("//*[@id=\"dob\"]")).sendKeys("02/21/2000");
          driver.findElement(By.xpath("//*[@id=\"address\"]")).sendKeys("pkl");
          WebElement dn=driver.findElement(By.xpath("//select[@id='securityQuestion']"));
            Select sel=new Select(dn);
            sel.selectByValue("411013");
            driver.findElement(By.xpath("//*[@id=\"answer\"]")).sendKeys("Navya");
