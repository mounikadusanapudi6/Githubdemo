...
public void user_accessing_registration_link_in_TESTME_app() {
    // Write code here that turns the phrase above into concrete actions
    //throw new cucumber.api.PendingException();
	System.out.println("registration accessed");
}

@When("user providing valid datafor all required fields")
public void user_providing_valid_datafor_all_required_fields() {
    // Write code here that turns the phrase above into concrete actions
    //throw new cucumber.api.PendingException();
...
public void testme_is_launched_and_is_accessible() {
    // Write code here that turns the phrase above into concrete actions
   // throw new cucumber.api.PendingException();
	System.out.println("TESTME launched");
}
